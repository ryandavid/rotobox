...
const char *dlac_alphabet = "\x03" "ABCDEFGHIJKLMNOPQRSTUVWXYZ\x1A\t\x1E\n| !\"#$%&'()*+,-./0123456789:;<=>?";

const char *decode_dlac(uint8_t *data, unsigned bytelen)
{
...
const char *get_fisb_product_name(uint16_t product_id)
{
    switch (product_id) {
